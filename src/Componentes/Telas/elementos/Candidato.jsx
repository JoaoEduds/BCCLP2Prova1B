...
export default function Candidato(props) {
    ...
    const [descurtida,setDescurtida] = useState(0);

    function addCurtida(curtida){
        setCurtida(curtida+1);
    }

    function addDesc(descurtida){
        setDescurtida(descurtida+1);
    }
        ...
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Card.Text>
                    ...
                    <p>{"Curtidas: " + curtida}</p>
                    <p>{"Descuridas: " + descurtida}</p>
                ...
                <Button className="mt-1" variant="success" onClick={()=>{
                    props.detalhesDoCandidato(props.candidato)
